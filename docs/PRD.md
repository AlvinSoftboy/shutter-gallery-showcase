...
## 1. Ringkasan Produk
Website portofolio personal branding untuk fotografer profesional, terinspirasi dari [petermckinnon.com](https://www.petermckinnon.com/). Fokus pada visual-first storytelling, galeri karya, personal brand, dan monetisasi (preset, kursus, kolaborasi/booking).
...
- Font: sans-serif modern (Inter, Space Grotesk, atau Neue Haas).
