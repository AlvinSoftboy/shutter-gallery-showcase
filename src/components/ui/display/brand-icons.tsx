...
export function InstagramIcon({ className, ...props }: Readonly<IconProps>) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function YoutubeIcon({ className, ...props }: Readonly<IconProps>) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function XIcon({ className, ...props }: Readonly<IconProps>) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
