...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "px-2 has-[[role=checkbox]]:pr-0 h-10 font-medium text-muted-foreground text-left align-middle *:[[role=checkbox]]:translate-y-0.5",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-2 has-[[role=checkbox]]:pr-0 align-middle *:[[role=checkbox]]:translate-y-0.5",
      className,
    )}
    {...props}
  />
